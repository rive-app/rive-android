...
extern "C"
{
    ...
    Java_app_rive_runtime_kotlin_renderers_RendererSkia_constructor(JNIEnv*, jobject, jboolean);
    ...
    Java_app_rive_runtime_kotlin_renderers_RendererSkia_cppSetSurface(JNIEnv*,
                                                                      jobject,
                                                                      jobject,
                                                                      jlong);

    JNIEXPORT void JNICALL
    Java_app_rive_runtime_kotlin_renderers_RendererSkia_cppClearSurface(JNIEnv*, jobject, jlong);

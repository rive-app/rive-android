...
namespace rive_android
{
	...
	jfieldID getClampId()
	{
		return getStaticFieldId(
		    getTileModeClass(), "CLAMP", "Landroid/graphics/Shader$TileMode;");
	};
	jfieldID getRepeatId()
	{
		return getStaticFieldId(
		    getTileModeClass(), "REPEAT", "Landroid/graphics/Shader$TileMode;");
	};
	jfieldID getMirrorId()
	{
		return getStaticFieldId(
		    getTileModeClass(), "MIRROR", "Landroid/graphics/Shader$TileMode;");
	};
	...
	{
		return getMethodId(
		    getPaintClass(), "setStyle", "(Landroid/graphics/Paint$Style;)V");
	};
	...
	{
		return getMethodId(
		    getPaintClass(), "setStrokeCap", "(Landroid/graphics/Paint$Cap;)V");
	};
	...
	{
		return getMethodId(
		    getPaintClass(), "setBlendMode", "(Landroid/graphics/BlendMode;)V");
	};
	...
	;
	jmethodID getSaveMethodId()
	{
		return getMethodId(getRiveRendererClass(), "save", "()I");
	};
	jmethodID getRestoreMethodId()
	{
		return getMethodId(getRiveRendererClass(), "restore", "()V");
	};
	jmethodID getSetMatrixMethodId()
	{
		return getMethodId(getRiveRendererClass(),
		                   "setMatrix",
		                   "(Landroid/graphics/Matrix;)V");
	};
	jmethodID getTranslateMethodId()
	{
		return getMethodId(getRiveRendererClass(), "translate", "(FF)V");
	};
	jmethodID getDrawPathMethodId()
	{
		return getMethodId(
	...
	jmethodID getClipPathMethodId()
	{
		return getMethodId(
		    getRiveRendererClass(), "clipPath", "(Landroid/graphics/Path;)Z");
	};
	...
	{
		return getStaticFieldId(
		    getStyleClass(), "FILL", "Landroid/graphics/Paint$Style;");
	};
	jfieldID getStrokeId()
	{
		return getStaticFieldId(
		    getStyleClass(), "STROKE", "Landroid/graphics/Paint$Style;");
	};
	jfieldID getMiterId()
	{
		return getStaticFieldId(
		    getJoinClass(), "MITER", "Landroid/graphics/Paint$Join;");
	};
	jfieldID getRoundId()
	{
		return getStaticFieldId(
		    getJoinClass(), "ROUND", "Landroid/graphics/Paint$Join;");
	};
	jfieldID getBevelId()
	{
		return getStaticFieldId(
		    getJoinClass(), "BEVEL", "Landroid/graphics/Paint$Join;");
	};
	jfieldID getCapButtID()
	{
		return getStaticFieldId(
		    getCapClass(), "BUTT", "Landroid/graphics/Paint$Cap;");
	};
	jfieldID getCapRoundId()
	{
		return getStaticFieldId(
		    getCapClass(), "ROUND", "Landroid/graphics/Paint$Cap;");
	};
	jfieldID getCapSquareId()
	{
		return getStaticFieldId(
		    getCapClass(), "SQUARE", "Landroid/graphics/Paint$Cap;");
	};

	jfieldID getEvenOddId()
	{
		return getStaticFieldId(
		    getFillTypeClass(), "EVEN_ODD", "Landroid/graphics/Path$FillType;");
	};
	jfieldID getNonZeroId()
	{
		return getStaticFieldId(
		    getFillTypeClass(), "WINDING", "Landroid/graphics/Path$FillType;");
	};
	...
	{
		return getStaticFieldId(
		    getBlendModeClass(), "SRC_OVER", "Landroid/graphics/BlendMode;");
	};
	jfieldID getScreen()
	{
		return getStaticFieldId(
		    getBlendModeClass(), "SCREEN", "Landroid/graphics/BlendMode;");
	};
	jfieldID getOverlay()
	{
		return getStaticFieldId(
		    getBlendModeClass(), "OVERLAY", "Landroid/graphics/BlendMode;");
	};
	jfieldID getDarken()
	{
		return getStaticFieldId(
		    getBlendModeClass(), "DARKEN", "Landroid/graphics/BlendMode;");
	};
	jfieldID getLighten()
	{
		return getStaticFieldId(
		    getBlendModeClass(), "LIGHTEN", "Landroid/graphics/BlendMode;");
	};
	jfieldID getColorDodge()
	{
		return getStaticFieldId(
		    getBlendModeClass(), "COLOR_DODGE", "Landroid/graphics/BlendMode;");
	};
	jfieldID getColorBurn()
	{
		return getStaticFieldId(
		    getBlendModeClass(), "COLOR_BURN", "Landroid/graphics/BlendMode;");
	};
	jfieldID getHardLight()
	{
		return getStaticFieldId(
		    getBlendModeClass(), "HARD_LIGHT", "Landroid/graphics/BlendMode;");
	};
	jfieldID getSoftLight()
	{
		return getStaticFieldId(
		    getBlendModeClass(), "SOFT_LIGHT", "Landroid/graphics/BlendMode;");
	};
	jfieldID getDifference()
	{
		return getStaticFieldId(
		    getBlendModeClass(), "DIFFERENCE", "Landroid/graphics/BlendMode;");
	};
	jfieldID getExclusion()
	{
		return getStaticFieldId(
		    getBlendModeClass(), "EXCLUSION", "Landroid/graphics/BlendMode;");
	};
	jfieldID getMultiply()
	{
		return getStaticFieldId(
		    getBlendModeClass(), "MULTIPLY", "Landroid/graphics/BlendMode;");
	};
	jfieldID getHue()
	{
		return getStaticFieldId(
		    getBlendModeClass(), "HUE", "Landroid/graphics/BlendMode;");
	};
	jfieldID getSaturation()
	{
		return getStaticFieldId(
		    getBlendModeClass(), "SATURATION", "Landroid/graphics/BlendMode;");
	};
	jfieldID getColor()
	{
		return getStaticFieldId(
		    getBlendModeClass(), "COLOR", "Landroid/graphics/BlendMode;");
	};
	jfieldID getLuminosity()
	{
		return getStaticFieldId(
		    getBlendModeClass(), "LUMINOSITY", "Landroid/graphics/BlendMode;");
	};
	jfieldID getClear()
	{
		return getStaticFieldId(
		    getBlendModeClass(), "CLEAR", "Landroid/graphics/BlendMode;");
	};
	...
	{
		return getStaticFieldId(
		    getPorterDuffClass(), "SRC", "Landroid/graphics/PorterDuff$Mode;");
	};
	jfieldID getPdDst()
	{
		return getStaticFieldId(
		    getPorterDuffClass(), "DST", "Landroid/graphics/PorterDuff$Mode;");
	};
	...
	{
		return getStaticFieldId(
		    getPorterDuffClass(), "XOR", "Landroid/graphics/PorterDuff$Mode;");
	};
	...
	{
		return getStaticFieldId(
		    getPorterDuffClass(), "ADD", "Landroid/graphics/PorterDuff$Mode;");
	};

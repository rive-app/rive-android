...
JNIEXPORT jlong JNICALL Java_app_rive_runtime_kotlin_core_File_cppArtboardByName(JNIEnv* env,
                                                                                 jobject thisObj,
                                                                                 jlong ref,
                                                                                 jstring name) {
    auto file = (rive::File*)ref;
...
JNIEXPORT jlong JNICALL Java_app_rive_runtime_kotlin_core_File_cppArtboardByIndex(JNIEnv* env,
                                                                                  jobject thisObj,
                                                                                  jlong ref,
                                                                                  jint index) {
    auto file = (rive::File*)ref;

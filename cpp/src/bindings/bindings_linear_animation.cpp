...
extern "C"
{
	...
	Java_app_rive_runtime_kotlin_core_Animation_cppName(JNIEnv* env,
	                                                    jobject thisObj,
	                                                    jlong ref)
	{
	...
	Java_app_rive_runtime_kotlin_core_Animation_cppDuration(JNIEnv* env,
	                                                        jobject thisObj,
	                                                        jlong ref)
	{
		auto* animation = (const rive::LinearAnimation*)ref;
	...
	JNIEXPORT jint JNICALL
	Java_app_rive_runtime_kotlin_core_Animation_cppWorkStart(JNIEnv* env,
	                                                         jobject thisObj,
	                                                         jlong ref)
	{
		auto* animation = (const rive::LinearAnimation*)ref;
	...
	JNIEXPORT jint JNICALL
	Java_app_rive_runtime_kotlin_core_Animation_cppWorkEnd(JNIEnv* env,
	                                                       jobject thisObj,
	                                                       jlong ref)
	{
		auto* animation = (const rive::LinearAnimation*)ref;
	...
	JNIEXPORT jint JNICALL
	Java_app_rive_runtime_kotlin_core_Animation_cppGetLoop(JNIEnv* env,
	                                                       jobject thisObj,
	                                                       jlong ref)
	{
		auto* animation = (const rive::LinearAnimation*)ref;

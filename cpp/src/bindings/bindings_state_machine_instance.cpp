...
// ANIMATION
JNIEXPORT jstring JNICALL Java_app_rive_runtime_kotlin_core_StateMachineInstance_cppName(
    JNIEnv* env, jobject thisObj, jlong ref) {
    auto stateMachineInstance = (rive::StateMachineInstance*)ref;
    return env->NewStringUTF(stateMachineInstance->stateMachine()->name().c_str());
}

JNIEXPORT jint JNICALL Java_app_rive_runtime_kotlin_core_StateMachineInstance_cppLayerCount(
    JNIEnv* env, jobject thisObj, jlong ref) {
    auto stateMachineInstance = (rive::StateMachineInstance*)ref;
    return (jint)stateMachineInstance->stateMachine()->layerCount();
}

JNIEXPORT void JNICALL Java_app_rive_runtime_kotlin_core_StateMachineInstance_cppPointerDown(
    JNIEnv* env, jobject thisObj, jlong ref, jfloat x, jfloat y) {
    auto stateMachineInstance = (rive::StateMachineInstance*)ref;
    stateMachineInstance->pointerDown(rive::Vec2D(x, y));
}

JNIEXPORT void JNICALL Java_app_rive_runtime_kotlin_core_StateMachineInstance_cppPointerMove(
    JNIEnv* env, jobject thisObj, jlong ref, jfloat x, jfloat y) {
    auto stateMachineInstance = (rive::StateMachineInstance*)ref;
    stateMachineInstance->pointerMove(rive::Vec2D(x, y));
}

JNIEXPORT void JNICALL Java_app_rive_runtime_kotlin_core_StateMachineInstance_cppPointerUp(
    JNIEnv* env, jobject thisObj, jlong ref, jfloat x, jfloat y) {
    auto stateMachineInstance = (rive::StateMachineInstance*)ref;

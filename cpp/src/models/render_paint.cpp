...
JNIRenderPaint::~JNIRenderPaint() { getJNIEnv()->DeleteGlobalRef(jObject); }
...
void JNIRenderPaint::style(rive::RenderPaintStyle value)
{
	...
	env->CallVoidMethod(jObject, getSetStyleMethodId(), staticObject);
...
void JNIRenderPaint::join(rive::StrokeJoin value)
{
	...
	env->CallVoidMethod(jObject, getSetStrokeJoinMethodId(), staticObject);
...
void JNIRenderPaint::cap(rive::StrokeCap value)
{
	...
	env->CallVoidMethod(jObject, getSetStrokeCapMethodId(), staticObject);
...
void JNIRenderPaint::porterDuffBlendMode(rive::BlendMode value)
{
	...
	jobject extraXferModeObject = env->CallObjectMethod(
	    jObject, getSetXfermodeMethodId(), xferModeObject);
...
void JNIRenderPaint::blendMode(rive::BlendMode value)
{
	...
	env->CallVoidMethod(
	    jObject, getSetBlendModeMethodId(), blendModeStaticObject);

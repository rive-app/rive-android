...
class MainActivity : ComponentActivity() {
    private val buttonsData = listOf(
        ...
        Pair(R.id.go_deferred_renderer, DeferredRendererActivity::class.java),
        ...
        Pair(R.id.go_semantics, SemanticActivity::class.java),
        Pair(R.id.go_semantics_test, SemanticsTestActivity::class.java),
        Pair(R.id.go_semantics_harness, SemanticsHarnessActivity::class.java),
